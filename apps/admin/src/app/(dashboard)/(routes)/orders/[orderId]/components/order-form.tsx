...
export const OrderForm: React.FC<ProductFormProps> = ({ initialData }) => {
   ...
   const defaultValues = initialData
      ? {
           ...initialData,
           shipping: parseFloat(Number(initialData?.shipping || 0).toFixed(2)),
           payable: parseFloat(Number(initialData?.payable || 0).toFixed(2)),
           discount: parseFloat(Number(initialData?.discount || 0).toFixed(2)),
        }
      : {
           status: '---',
           shipping: 0,
